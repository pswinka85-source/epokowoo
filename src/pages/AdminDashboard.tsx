...
import { BookOpen, Brain, ArrowLeft, ChevronDown, Settings, FileText } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  const [activeSection, setActiveSection] = useState<"lessons" | "quizzes" | "epoch" | "worksheets">("lessons");
